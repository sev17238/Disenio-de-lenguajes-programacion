        ...
        try:
            while i < len(tokens):
                ...
                # Current token is a number, push it to stack for numbers.
                    ...
                    while (i < len(tokens) and (tokens[i].isdigit() or self.isDecimal(tokens[i])) ):
                        ...
                        # Check if current token is a decimal
                            ...
                            while (i < len(tokens) and (tokens[i].isdigit() or self.isDecimal(tokens[i])) ):
                                if(self.isDecimal(tokens[i]) == False):
...
if __name__ == "__main__":
    ...
    print(calc.evaluate("100+2*6"))
    print(calc.evaluate("10*(2+(1.2*(20+2/3)))/14"))
    print(calc.evaluate('26+(.248+(5/.2335))'))
